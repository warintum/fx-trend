...
function buildAnalysisPrompt(symbol: string, data: TimeframeAnalysisData, duration: 'short' | 'medium', modelVersion: string): string {
    ...
    // Calculate Technical Data for context (Not hard filters anymore)
...
🚀 **คำสั่งพิเศษสำหรับรุ่น LITE:**
- **ความถูกต้องของ JSON:** ต้องตอบกลับในรูปแบบ JSON ที่ถูกต้องเท่านั้น
- **ความรอบคอบ:** หากราคาไม่อยู่ในโซน Demand/Supply ที่ชัดเจน ให้เลือกประเภทสัญญาณเป็น "WAIT" เสมอ
    `;
