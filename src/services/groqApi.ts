...
- \`support\` และ \`resistance\` ใน JSON ต้องเป็น **Array ของตัวเลข 2 ตัว** ที่แสดงถึง **ช่วงราคาที่กว้างพอ (ขอบบนและขอบล่าง)** เสมอ เช่น [2400.50, 2390.00] **ห้ามใส่ตัวเลขเดียวกัน** และ **ห้ามเขียนตัวเลขต่อกันเด็ดขาด** (ต้องมีคอมม่าคั่น) โซนควรมีความกว้างประมาณ 1.0 - 3.0 points สำหรับทองคำ
    `;
...
{"currentPrice":${latestPrice.toFixed(2)},"trend":"BULLISH|BEARISH|SIDEWAYS","structure":"วิเคราะห์โครงสร้างตลาด H4/H1 และสภาวะปัจจุบันใน M30","keyLevels":{"support":[0.0,0.0],"resistance":[0.0,0.0]},"signal":{"type":"BUY|SELL|WAIT","entryPrice":0.0,"stopLoss":0.0,"takeProfit":0.0,"confidence":0-100,"reasoning":"อธิบายเหตุผล 4-6 ประโยค: 1) วิเคราะห์เทรนด์ H4 2) ระบุ Demand/Supply Zone สำคัญ 3) มองว่าราคาปัจจุบันเป็นการย่อตัวเข้าหาแนวรับหรือการเด้งหาแนวต้านหรือไม่ 4) ระบุเป้าหมายและการคุมความเสี่ยง"},"summary":"สรุปแผน Day Trade ประจำวัน"}`;
    }
}
